...
<div class="form_body">
    <div class="wrapper sign_up">
        <form action="/auth/sign-up" class="sign-up-form" method="post">
            <h2>Sign Up</h2>
            <c:if test="${isExist}">
            ...
            <div class="input-field">
                <input type="text" name="phone" class="phone" oninput="formatPhoneNumber(this)" required>
                <label>Enter your phone</label>
            </div>
            <div class="input-field">
                <input type="password" minlength="5" id="password1" name="password" required>
                <label>Enter your password</label>
                <i style="color: #fff" class="fas fa-eye toggle-password btn-2"></i>
            </div>
            <div class="input-field">
                <input type="password" minlength="5" id="password2" required>
                <label>Confirm your password</label>
            </div>
            <button type="submit">Sign Up</button>
            <div class="register">
                <p>Do you have an account? <a href="/auth/sign-in">Sign In</a></p>
            </div>
        </form>
    </div>
</div>
